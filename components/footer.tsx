          ...
          <div className="max-w-2xl mx-auto text-center space-y-6">
            ...
            <form onSubmit={handleSubscribe} className="flex gap-2">
              <input
                ...
                className="flex-1 bg-input border border-border px-4 py-3 text-sm rounded text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-accent transition"
                required
              />
              <ModernButton 
                type="submit"
                className="py-2 px-4 text-sm flex items-center justify-center"
              >
                Subscribe
              </ModernButton>
            </form>
